...
* [`src/cljs/midi_spider/`](src/cljs/midi_spider/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/midi_spider/core.cljs): contains the SPA entry point, `init`
* [`test/cljs/midi_spider/`](test/cljs/midi_spider/): test files (ClojureScript,
...
(headless test environment)
    * For Chromium, set the `CHROME_BIN` environment variable in your shell to the command that
    launches Chromium. For example, in Ubuntu, add the following line to your `.bashrc`:
       ...
       ```
7. Clone this repo and open a terminal in the `midi-spider` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/midi_spider/config.cljs) defaults to `true` in
...
MIDI Spider is [MIT licensed](LICENSE).
